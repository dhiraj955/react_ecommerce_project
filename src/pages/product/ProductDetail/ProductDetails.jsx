      ...
      <div className="productdetail" style={{ marginTop: "100px" }}>
        <div className="product-container">
          ...
          <div className="product-right">
            <h1>{getApi.title}</h1>
            <p className="parad">
              <span>Description:</span> {getApi.description}
            </p>
            <p>
              <span>Brand: </span>
              {getApi.brand}
            ...
            <p>
              <span>Category:</span> {getApi.category}
            </p>
            <p>
              <span>Price:</span> $ {getApi.price}
            </p>
            <p>
              <span> Discount: </span>
            ...
            <p>
              <span>Rating:</span> {getApi.rating}
            </p>
            <p>
              <span>Status: </span>
            ...
            <p>
              <span>Stock: </span> {getApi.stock}
            </p>
            <p>
              <span>Warranty:</span> {getApi.warrantyInformation}
            </p>
            <p className="padding">
              <span>Shipping: </span>
            ...
            <div className="btn-section">
              ...
              <button
                className="productdetail-btn"
                onClick={() => {
                  setSearchParams({ count: count + 1, search: search });
                }}
              >
                <FiPlus />
              </button>
